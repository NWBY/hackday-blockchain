...
class Block:
    ...
    def mine_block(last_block, data):
        """
        Mine a block on last block and given data, until a block hash is found
        that meets the leading 0's (difficulty) requirement
        """
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        Increase for quickly mined blocks & descrease for slowly mined blocks
        """
